...
function set_minimenu() {
    $('.minimenu')
        ...
        <li data_content="${prdId}" data_level="${prdLvl}" class="mini_option stokProd"><i class="fas fa-archive"></i> Inventario</li>
            `;
            $('.list_menu ul').html(H);
...
function stock_product(prdId, prdLvl) {
    console.log(prdId, prdLvl);
