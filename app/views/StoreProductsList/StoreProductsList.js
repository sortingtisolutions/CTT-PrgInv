...
function putProducts(dt) {
    if (dt[0].prd_id != '0') {
        ...
        $('.list-group').slideUp('100', function () {
            ...
            $.each(dt, function (v, u) {
                let H = `<div class="list-item" id="P-${u.prd_id}" data_complement="${u.ser_id}|${u.ser_sku}|${u.ser_serial_number}|${u.ser_cost}|${u.cin_id}">${u.ser_sku} - ${u.prd_name} - ${u.ser_serial_number}</div>`;
