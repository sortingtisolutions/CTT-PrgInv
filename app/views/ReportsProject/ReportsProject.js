    ...
    $('#tblExchanges').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                className: 'btn-apply hidden-field',
                action: function (e, dt, node, config) {
                    window.location = 'ReportsProject';
                },
            },
        ],
        paging: false,
...
function getExchange() {
    var pagina = 'ReportsProject/listExchange';
    var par = '[{"parm":""}]';
    var tipo = 'json';
...
function getStores() {
    var pagina = 'ReportsProject/listStores';
    var par = '[{"parm":""}]';
    var tipo = 'json';
...
function build_data_structure(pr) {
    let pa = `[{"par":"${pr}"}]`;
    var pagina = 'ReportsProject/saveList';
    var par = pa;
    var tipo = 'html';
...
function putSaveList(dt) {
    window.open(url + 'app/views/ReportsProject/ReportsProjectRep.php', '_blank');
}
